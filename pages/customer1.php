...
<body>
<div id="wrapper">
<a class = "btn btn-default btn-sm" href="cashier/sales.php?id=cash&invoice=IN00968940137"; style="font-size:20px"> <i class="fa fa-arrow-circle-left"></i> Back</a>
    <!-- Page Content -->
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">CUSTOMER LIST</h>
                </div>
