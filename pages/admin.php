	  ...
	  <div class="box-body">
		...
		<div class="col-lg-4">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="admin_add.php" method="POST" autocomplete="off">
						<div id="ac">
				...
				<div class="panel-footer"><button type="submit" class="btn btn-success btn-sm" name="admin_add"> <i class="glyphicon glyphicon-floppy-save"></i> Submit</button></div>
				</form>
			</div>
			<!-- /.panel -->
		</div>
		...
		<div class="col-lg-8">
			<div class="panel panel-info">
				<div class="panel-heading">
					<i class="glyphicon glyphicon-th-list"></i> List of Admin
				</div>
				<div class="panel-body">
