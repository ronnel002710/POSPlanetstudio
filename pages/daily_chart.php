...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daily Sales <?php $today =date('Y');  
					echo 'in Year '.$today;?></h1>
                </div>
                ...
                <div class="content" id="content">
                    ...
                    <div class="row">
                        ...
                        $sql = "SELECT *, date as mon, SUM(amount) as qcount FROM sales WHERE year='$year' GROUP BY mon";
